      ...
      <Body style={mainStyle}>
        <Container style={containerStyle}>
          ...
          {greeting && greeting !== "none" ? (
            <Text style={greetingStyleItem}>{greeting}</Text>
          ) : null}
          ...
          {/* New secondary text below job widget if enabled */}
          ...
          {showCtaButton && buttonText && buttonText.trim() !== "none" && buttonText.trim() !== "" && (
            <Section style={{ marginBottom: "24px", marginTop: "12px", textAlign: "center" }}>
              <Button style={applyButton} href={jobPublicUrl}>
                {buttonText}
              </Button>
              {secondaryText ? (
