...
export const SignupEmail = ({
  ...
  return (
    <Html>
      ...
      <Preview>Potvrďte svůj účet na Zrobee</Preview>
      <Body style={main} className="main-body">
        <Container style={container} className="container">
          ...
          <Heading style={h1 as any} className="h1">Vítejte na Zrobee!</Heading>

          <Text style={text} className="text">
            Děkujeme za registraci. Pro aktivaci účtu a přístup ke všem funkcím
