...
export const InviteEmail = ({
  ...
  return (
    <Html>
      ...
      <Preview>Pozvánka na Zrobee</Preview>
      <Body style={main} className="main-body">
        <Container style={container} className="container">
          ...
          <Heading style={h1 as any} className="h1">Byli jste pozváni na Zrobee</Heading>

          <Text style={text} className="text">
            Někdo vás pozval k připojení na platformu Zrobee. Klikněte na
            tlačítko níže pro přijetí pozvánky a vytvoření účtu.
          </Text>
          ...
          <Text style={footer} className="footer">
            Pokud nechcete pozvánku přijmout, tento e-mail můžete ignorovat.
          </Text>
