...
export const EmailChangeEmail = ({
  ...
  return (
    <Html>
      ...
      <Preview>Potvrzení změny e-mailu – Zrobee</Preview>
      <Body style={main} className="main-body">
        <Container style={container} className="container">
          ...
          <Heading style={h1 as any} className="h1">Změna e-mailové adresy</Heading>

          <Text style={text} className="text">
            Obdrželi jsme žádost o změnu e-mailové adresy vašeho účtu
            {newEmail ? ` na ${newEmail}` : ""}. Klikněte na tlačítko níže pro
            potvrzení změny.
          </Text>
          ...
          <Text style={footer} className="footer">
            Pokud jste o změnu e-mailu nežádali, tento e-mail můžete ignorovat.
          </Text>
