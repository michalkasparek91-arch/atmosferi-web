  ...
  try {
    ...
    for (const email of recipients) {
      ...
      const result = await sendEmail({
        ...
        signatureGreeting: template.signature_greeting || template.segment_filters?.signature_greeting,
        signatureRole: template.signature_role || template.segment_filters?.signature_role,
        signatureEmail: template.signature_email || template.segment_filters?.signature_email,
        
        // Modular fields
        heroImageUrl,
        heroCaption: template.hero_caption || template.segment_filters?.hero_caption,
        heroTagline: template.hero_tagline || template.segment_filters?.hero_tagline,
        carouselImages,
